...
route_ip = "192.168.204.0"
netmask = '24'
route_gateway = "192.168.204.1"
bond_name = 'bond0'
...
# This function add routes to netplan file and apply it
...
# This function delete route from netplan file and apply it
